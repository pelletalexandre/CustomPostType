...
if( !class_exists( 'MetaBox' ) ) {
    ...
    class MetaBox
    {
        ...
        public function __construct ( $arr_param/* $id, $libelle, $emplacement='normal', $priority='high', $callback=''*/ )
        {
            ...
            if ( isset ( $arr_param['display'] ) )
            {
                $this->display = $arr_param['display'];    
            }
        ...
        /**
         * Méthode qui affiche la métabox
         *
        ...
        public function callbackShowFields ( $post, $extra )
        {
            ...
            {
                call_user_func ( $extra['args']['callback'], $post, $this->cpt );
            }
            
            //On insert les éventuels script inline
            echo $this->cpt->inlineScript ( $this->id );
        }
    };
